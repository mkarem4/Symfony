 ...
 */
final class Version20191106123425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, user_id, content, title, featured_image, file FROM post');
        ...
        $this->addSql('INSERT INTO post (id, user_id, content, title, featured_image, file) SELECT id, user_id, content, title, featured_image, file FROM __temp__post');
